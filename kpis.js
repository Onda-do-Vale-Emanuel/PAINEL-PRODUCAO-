...
// metas por mês (como você tinha antes)
const METAS = {
...
Promise.all([
  ...
  if (!fat || !qtd || !ticket || !kg || !preco) {
    console.error("Algum JSON não carregou corretamente");
    return;
  }

  // mês para metas (pega do fim: DD/MM/AAAA)
